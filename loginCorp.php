...
<head>
	<meta charset = "UTF-8">
	<title>MadMotors - Corp Log in</title>
		...
		<div id = "cuerpoLogin">
			<div id = "ingresoLogin" class="cuerpo">
				<div id = "titulosSignLog" class="titulos">
					Ingreso de usuario corporativo
				</div>
				<div class = "formUser">
					<form id="formLog" method = "post">
						<p>
							<input type="text" name="rutUsuario" placeholder="RUT">
						</p>
						<p>
					...
					<div class = "alternarSignLogIn">Click <a href="loginCorp.php">aquí para login de cliente</a>.</div>
				</div>
			</div>
